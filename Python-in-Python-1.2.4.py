...
print('Python in Python '+(version:='1.2.4')+' (v'+version+'\\'+str(__version__:=23)+', Jul 2 2024 13:33:06),using Python '+sys.version+'\nType "help", "copyright", "credits" or "license" for more information.\nType "update" for new updates of "Python in Python"')
update=version+":Print function won't print Superfluous 'None'.Special Thanks:wangziwenhk \nWebsite:https://www.github.com/MMXCawa/Python-in-Python";
while 1:
    if __style__==0:
        command_collect()
        if c[0:5]=='print':
